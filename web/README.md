...
second step
[builds the Azure Function API](#build-the-remix-server-apition) from the
...
[Azure Functions](https://docs.microsoft.com/en-us/azure/apitions/functions-reference-node)
